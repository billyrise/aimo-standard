...
| --- | --- | --- | --- | --- | --- |
| Preuve | Enregistrements EV (JSON/tableau) | Oui | Enregistrement de ce qui s'est passé ; lien vers demande/revue/exception/renouvellement | id, timestamp, source, summary ; refs lifecycle optionnelles | [Validateur](../../validator/), aimo-ev.schema.json |
...
Voir [Exigences minimales de preuves](../minimum-evidence/) pour les champs OBLIGATOIRES et les groupes de cycle de vie.
...
!!! info "Intégrité et contrôle d'accès"
    ...
    Voir [Exigences minimales de preuves > Intégrité et accès](../minimum-evidence/#6-integrity-access) pour des orientations détaillées.

## Parcours d'audit

Depuis cette page, le parcours d'audit typique continue :

1. **Suivant** : [Exigences minimales de preuves](../minimum-evidence/) — liste de contrôle OBLIGATOIRE par cycle de vie
2. **Ensuite** : [Carte de couverture](../../coverage-map/) — correspondance avec les cadres externes
3. **Valider** : [Validateur](../../validator/) — exécuter les vérifications structurelles
