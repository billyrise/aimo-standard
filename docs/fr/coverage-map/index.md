...
3. Validez la complétude et la cohérence en utilisant le validateur, et appliquez une revue humaine là où c'est requis (voir [Protocole de surveillance humaine](../governance/human-oversight-protocol/)).

**Ressources clés :**

- [Taxonomie](../standard/current/03-taxonomy/) — codes de classification
- [Exigences minimales de preuves](../artifacts/minimum-evidence/) — liste de contrôle OBLIGATOIRE
- [Lot de preuves](../artifacts/evidence-bundle/) — structure du lot et TDM
- [Schémas de journaux](../artifacts/log-schemas/) — preuves Shadow AI / activité des agents
- [Validateur](../validator/) — vérifications de cohérence structurelle
- [Protocole de surveillance humaine](../governance/human-oversight-protocol/) — limite entre revue machine et humaine
