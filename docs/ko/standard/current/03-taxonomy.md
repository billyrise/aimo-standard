...
!!! warning "중요"
    AIMO 표준은 **설명 가능성 및 증거 준비**를 지원합니다. 법률 자문을 제공하거나, 컴플라이언스를 보장하거나, 어떤 규정 또는 프레임워크에 대한 적합성을 인증하지 **않습니다**. 자세한 내용은 [책임 경계](../../../governance/responsibility-boundary/)를 참조하세요.
...
!!! warning "참조 예시에 불과함 — 규범 코드 아님"
    아래 코드는 **설명 목적의 플레이스홀더**이며 규범적 AIMO 코드 체계의 일부가 **아닙니다**. 제출·운영에 사용하지 마시고, [Codes](../04-codes/)와 [Dictionary](../05-dictionary/)의 규범적 정의를 사용하세요.

- **AG-01** 폭주 루프 / 재귀
- **AG-02** 무단 도구 사용 (혼란된 대리인 스타일 오용)
- **AG-03** 권한 경계 드리프트

AG-*를 제출에 사용하지 마세요. Codes/Dictionary에 정의된 규범적 차원과 코드를 사용하세요.
...
30개 UC 코드의 전체 목록은 [딕셔너리](../05-dictionary/)를 참조하세요.
...
범위 노트 및 예시를 포함한 완전한 코드 정의는 [딕셔너리](../05-dictionary/)를 참조하세요.
...
- [코드](../04-codes/) - 코드 형식, 명명 규칙 및 생명주기
- [딕셔너리](../05-dictionary/) - 완전한 코드 목록 및 열 정의
- [증거 템플릿](../06-ev-template/) - 증거에서 코드를 사용하는 방법
- [책임 경계](../../../governance/responsibility-boundary/) - 과대 주장 금지 선언
