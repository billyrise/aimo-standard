...
감사자 준비 자료는 여기서 시작하세요: **[신뢰 패키지](trust-package/)**.
...
| [책임 경계](responsibility-boundary/) | AIMO가 제공하는 것과 제공하지 않는 것 |
| [보안](security/) | 취약점 보고 및 보안 정책 |
| [라이선스](license/) | 라이선스 조건 (Apache-2.0) |
| [상표](trademarks/) | 상표 사용 지침 |
| [인용 방법](cite/) | 논문 및 감사를 위한 인용 지침 |
| [기여하기](contributing/) | AIMO 표준에 기여하는 방법 |
| [SEO 및 정식 URL 정책](seo-canonical-policy/) | URL 정식화 지침 |
...
1. **[신뢰 패키지](trust-package/)** — 감사 준비 자료 개요
2. **[책임 경계](responsibility-boundary/)** — 범위 및 채택자 책임
3. **[보안](security/)** — 보안 태세 및 공개 정책
4. **[라이선스](license/)** — 채택을 위한 라이선스 조건
5. **[인용 방법](cite/)** — 감사 문서를 위한 인용

## 관련 페이지

- [릴리스](../../releases/) — 릴리스 스냅샷 및 변경로그
- [적합성](../conformance/) — 적합성 수준
- [현지화 가이드](../contributing/localization/) — i18n 워크플로우
