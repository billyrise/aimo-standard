...
- **タクソノミー**: AIガバナンスの8次元分類体系 — [タクソノミー](../standard/current/03-taxonomy.ja.md)、[コード](../standard/current/04-codes.ja.md)、[辞書](../standard/current/05-dictionary.ja.md)
...
| タクソノミー＆辞書 | [タクソノミー](../standard/current/03-taxonomy.ja.md)、[コード](../standard/current/04-codes.ja.md)、[辞書](../standard/current/05-dictionary.ja.md) | AIシステムの分類体系（8次元、91コード） |
...
1. **分類体系**: [タクソノミー](../standard/current/03-taxonomy.ja.md) + [辞書](../standard/current/05-dictionary.ja.md) — 8次元コード体系を理解
2. **証跡構造**: [Evidence Bundle](../artifacts/evidence-bundle.ja.md) — バンドル TOC と追跡可能性を理解
3. **必須証跡**: [Minimum Evidence Requirements](../artifacts/minimum-evidence.ja.md) — ライフサイクル別 MUST チェックリスト
4. **フレームワーク整合**: [Coverage Map](../coverage-map/index.ja.md) + [Methodology](../coverage-map/methodology.ja.md) — AIMO と外部フレームワークの対応を確認
5. **検証**: [Validator](../validator/index.ja.md) — 構造整合性チェックを実行
6. **ダウンロード**: [Releases](../releases/index.ja.md) — リリースアセットを取得しチェックサムを検証
