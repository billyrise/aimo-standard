...
監査対応資料はこちらから: [Trust Package](trust-package.ja.md)。

- **責任境界**: [責任境界](responsibility-boundary.ja.md) — AIMO が提供するもの・しないもの、前提条件、採用者責任。
...
リリーススナップショットと変更履歴は [Releases](../releases/index.ja.md) を参照。
