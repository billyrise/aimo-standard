...
**[GitHub Releases](https://github.com/billyrise/aimo-standard/releases/latest)** — this is the single source of truth for "latest" release. The site path `/latest/` redirects to the same version.
