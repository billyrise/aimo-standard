...
```
v0.1.0: FS-007 introduced (status: active)
v0.2.0: FS-007 deprecated (status: deprecated, replaced_by: FS-008)
v0.3.0: FS-007 still available with deprecation warning
