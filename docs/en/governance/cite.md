...
| Version | (specify the version used, e.g., v0.1.1) |
...
| Specific version | https://standard.aimoaas.com/0.1.1/ |
| GitHub releases | https://github.com/billyrise/aimo-standard/releases |

!!! note "Site Path Format"
    Site paths use version numbers without the `v` prefix. For version `v0.1.1`, use `/0.1.1/` in URLs.
