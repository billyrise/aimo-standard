...
> AIMO Standard Contributors. (2026). *AIMO Standard* (Version 0.1.2) [Software]. https://standard.aimoaas.com/

## Version-Specific Citation

When citing a specific version:

> AIMO Standard Contributors. (2026). AIMO Standard v0.1.2. https://github.com/billyrise/aimo-standard/releases/tag/v0.1.2
...
| Version | (specify the version used, e.g., v0.1.2) |
...
| Specific version | https://standard.aimoaas.com/0.1.2/ |
| GitHub releases | https://github.com/billyrise/aimo-standard/releases |

!!! note "Site Path Format"
    Site paths use version numbers without the `v` prefix. For version `v0.1.2`, use `/0.1.2/` in URLs.
