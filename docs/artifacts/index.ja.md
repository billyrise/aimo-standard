...
本セクションは、AIMO Standard を実装する機械可読・人間可読アーティファクトのハブである。
構造の SSOT はアーティファクトであり、docs は利用方法を説明する。
...
- **例**: 最小サンプルは [Examples](../examples/index.md) を参照。

監査対応のパッケージ化は [Trust Package](../governance/trust-package.md) を参照。
