...
- **適合性**: コンプライアンスの主張方法とレベルの意味 — [Conformance](../conformance/index.md)
- **カバレッジマップ**: 外部標準へのマッピング — [カバレッジマップ索引](../coverage-map/index.md)、[カバレッジマップ方法論](../coverage-map/methodology.md)
- **標準**: 規範的要件と定義 — [Standard (Current)](../standard/current/index.md)
- **タクソノミー**: AIガバナンスの8次元分類体系 — [タクソノミー](../standard/current/03-taxonomy.md)、[コード](../standard/current/04-codes.md)、[辞書](../standard/current/05-dictionary.md)
- **エビデンスバンドル**: 構造、TOC、トレーサビリティ — [Evidence Bundle](../artifacts/evidence-bundle.md)
- **最小エビデンス要件**: ライフサイクル別MUSTレベルチェックリスト — [Minimum Evidence Requirements](../artifacts/minimum-evidence.md)
- **バリデータ**: ルールと参照チェック — [Validator](../validator/index.md)
- **例**: 監査対応サンプルバンドル — [Examples](../examples/index.md)
- **リリース**: 変更履歴と配布 — [Releases](../releases/index.md)
- **ガバナンス**: ポリシー、セキュリティ、ライセンス — [Governance](../governance/index.md)

## 監査対応のための最小セット

| 項目 | 場所 | 成果 / 証明されること |
| --- | --- | --- |
| 適合性レベル | [Conformance](../conformance/index.md) | コンプライアンスの主張方法と必要なエビデンスの範囲 |
| カバレッジマッピング | [カバレッジマップ索引](../coverage-map/index.md)、[カバレッジマップ方法論](../coverage-map/methodology.md) | 外部規制・標準に対する説明可能性 |
| タクソノミー＆辞書 | [タクソノミー](../standard/current/03-taxonomy.md)、[コード](../standard/current/04-codes.md)、[辞書](../standard/current/05-dictionary.md) | AIシステムの分類体系（8次元、91コード） |
| エビデンス成果物 | [Evidence Bundle](../artifacts/evidence-bundle.md)、[Minimum Evidence](../artifacts/minimum-evidence.md)、[EV Template](../standard/current/06-ev-template.md) | トレーサビリティをサポートするために存在すべきデータ |
| バリデータチェック | [Validator](../validator/index.md) | 内部一貫性と完全性の検証方法 |
| サンプルバンドル | [Examples](../examples/index.md) | 監査対応パッケージの実例 |
| 変更管理 | [Releases](../releases/index.md)、[Governance](../governance/index.md) | 更新の管理と通知方法 |
| セキュリティ / ライセンス / 商標 | [Governance](../governance/index.md) | 採用決定のための法的・セキュリティ体制 |

## 引用方法

引用ガイダンスとコンテキストはリポジトリREADMEを使用してください。ガバナンスは権威あるポリシーにリンクしています。
[README.md](https://github.com/billyrise/aimo-standard/blob/main/README.md) と [Governance](../governance/index.md) を参照。
...
スコープ定義、前提条件、採用者責任の詳細は [責任境界](responsibility-boundary.md) を参照。
...
リリースアセットと検証については [Releases](../releases/index.md) を参照。
...
スコープ、前提条件、採用者責任の詳細は [責任境界](responsibility-boundary.md) を参照。
...
!!! success "ビルド来歴証明が利用可能"
    v0.1.6以降、すべてのリリースアセットには暗号署名付きビルド来歴証明が含まれています。attestation 検証手順は [バージョンページの検証手順](../standard/versions/index.md) を参照してください。
...
1. **分類体系**: [タクソノミー](../standard/current/03-taxonomy.md) + [辞書](../standard/current/05-dictionary.md) — 8次元コード体系を理解
2. **証跡構造**: [Evidence Bundle](../artifacts/evidence-bundle.md) — バンドル TOC と追跡可能性を理解
3. **必須証跡**: [Minimum Evidence Requirements](../artifacts/minimum-evidence.md) — ライフサイクル別 MUST チェックリスト
4. **フレームワーク整合**: [Coverage Map](../coverage-map/index.md) + [Methodology](../coverage-map/methodology.md) — AIMO と外部フレームワークの対応を確認
5. **検証**: [Validator](../validator/index.md) — 構造整合性チェックを実行
6. **ダウンロード**: [Releases](../releases/index.md) — リリースアセットを取得しチェックサムを検証
