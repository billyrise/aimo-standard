...
| 種別 | ファイル | 説明 |
| --- | --- | --- |
| **SSOT** | `source_pack/03_taxonomy/taxonomy_dictionary_v0.1.csv` | 唯一の正（91コード、21列） |
...
| 互換 | `source_pack/03_taxonomy/dictionary_seed.csv` | 互換コピー（SSOTと同一） |

**このドキュメントページは説明用です。** 正式な定義については、常に`source_pack/03_taxonomy/`内のSSOTファイル`taxonomy_dictionary_v0.1.csv`を参照してください。
...
4. `dictionary_seed.csv`を互換コピーとして同期
5. 必要に応じてドキュメントページを更新
6. すべての変更をまとめてコミット
