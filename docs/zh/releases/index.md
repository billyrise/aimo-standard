...
- **[Standard → 版本 → 验证程序](../standard/versions/index.md)** — 分步校验和验证（Linux/macOS/Windows）及来源证明。
...
有关完整的验证程序（校验和、证明、分步），请参阅 **[Standard → 版本 → 验证程序](../standard/versions/index.md)**。另见 [信任包](../governance/trust-package.md) 获取审计就绪材料。
