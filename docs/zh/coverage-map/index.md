...
3. 使用验证器验证完整性和一致性，并在需要时应用人工审查（参见 [人工监督协议](../governance/human-oversight-protocol/)）。

**关键资源：**

- [分类法](../standard/current/03-taxonomy/) — 分类代码
- [最低证据要求](../artifacts/minimum-evidence/) — MUST 级别清单
- [证据包](../artifacts/evidence-bundle/) — 包结构和目录
- [日志模式](../artifacts/log-schemas/) — 影子AI/代理活动证据
- [验证器](../validator/) — 结构一致性检查
- [人工监督协议](../governance/human-oversight-protocol/) — 机器与人工审查的边界
